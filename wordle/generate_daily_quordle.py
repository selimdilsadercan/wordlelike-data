"""
Quordle için Günlük Kelime Seçici

Bu script, Quordle oyunu için 100 günlük kelime seti seçer.
Her gün 4 kelime seçilir.
Kurallar:
...
def main():
    print("=" * 50)
    print("🔤 QUORDLE GÜNLÜK KELİME SEÇİCİ")
    print("=" * 50)
    ...
    output_data = {
        ...
        "total_days": len(daily_quordle),
        "words_per_day": WORDS_PER_DAY,
        "cooldown_days": COOLDOWN_DAYS,
        "daily_quordle": daily_quordle
    }
